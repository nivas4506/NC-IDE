...
void TabManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->tabDirtyStateChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 1: _t->allTabsClosed(); break;
        case 2: _t->activeFileChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        case 6: _t->onEditorModified(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TabManager::*)(int , bool )>(_a, &TabManager::tabDirtyStateChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabManager::*)()>(_a, &TabManager::allTabsClosed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabManager::*)(const QString & )>(_a, &TabManager::activeFileChanged, 2))
            return;
    }
}
...
// SIGNAL 0
void TabManager::tabDirtyStateChanged(int _t1, bool _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void TabManager::allTabsClosed()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TabManager::activeFileChanged(const QString & _t1)
{
