...
void ActivityBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->activityChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->toggleSidebar(); break;
        case 2: _t->onButtonClicked((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ActivityBar::*)(int )>(_a, &ActivityBar::activityChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ActivityBar::*)()>(_a, &ActivityBar::toggleSidebar, 1))
            return;
    }
}
...
// SIGNAL 0
void ActivityBar::activityChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ActivityBar::toggleSidebar()
{
