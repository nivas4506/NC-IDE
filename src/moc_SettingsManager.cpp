...
template <> constexpr inline auto SettingsManager::qt_create_metaobjectdata<qt_meta_tag_ZN15SettingsManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(bool, int)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void SettingsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fontChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 2: _t->autoSaveSettingsChanged((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsManager::*)(const QString & )>(_a, &SettingsManager::themeChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingsManager::*)(const QString & , int )>(_a, &SettingsManager::fontChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingsManager::*)(bool , int )>(_a, &SettingsManager::autoSaveSettingsChanged, 2))
            return;
    }
}
...
// SIGNAL 1
void SettingsManager::fontChanged(const QString & _t1, int _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2);
}

// SIGNAL 2
void SettingsManager::autoSaveSettingsChanged(bool _t1, int _t2)
{
