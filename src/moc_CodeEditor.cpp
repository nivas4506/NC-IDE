...
void CodeEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->cursorPositionChanged2((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        case 4: _t->matchBrackets(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CodeEditor::*)(const QString & )>(_a, &CodeEditor::cursorPositionChanged2, 0))
            return;
    }
}
...
// SIGNAL 0
void CodeEditor::cursorPositionChanged2(const QString & _t1)
{
